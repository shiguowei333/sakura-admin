          ...
          <el-table-column prop="is_active" label="状态" width="200">
            <template #default="{ row }">
              <el-switch @change="changeStatus(e, row)" v-model="row.is_active" active-text="启用" inactive-text="禁用"
                inline-prompt size="large" style="--el-switch-on-color: #13ce66; --el-switch-off-color: #ff4949" />
            </template>
          </el-table-column>
    ...
    <el-dialog v-model="isDialogVisible" :title="isEditMode ? '编辑用户' : '新增用户'" :width="'40%'">
      <el-form ref="userFormRef" :model="userData" :rules="rules" label-width="80px" label-position="right">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="手机号" prop="telephone">
              <el-input v-model="userData.telephone" maxlength="11" show-word-limit placeholder="请输入手机号" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="所属部门" prop="department">
              <el-cascader v-model="userData.department" :options="deptList" :width="100"
                ...
                :show-all-levels="false" placeholder="请选择所属部门" />
            </el-form-item>
          </el-col>
          <el-col v-if="!isEditMode" :span="12">
            <el-form-item label="用户状态" prop="is_active">
