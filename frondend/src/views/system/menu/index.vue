        ...
        <div class="inner-table">
          ...
          <el-table-column label="菜单名称" style="">
            <template #default="{ row }">
                <IconifyIconOnline style="display: inline-block; vertical-align: middle;" :icon="row.icon" />&nbsp;{{ row.title }}
            </template>
          </el-table-column>
            ...
            <el-row :gutter="20">
              ...
              <el-col :span=12>
                <el-form-item label="上级菜单" >
                  <el-cascader style="width: 100%;" v-model="menuData.parent" :options="dataList" :props="{ value: 'id', label: 'title', children: 'children', checkStrictly: true }" clearable filterable :show-all-levels="false" placeholder="请选择上级菜单" />
                </el-form-item>
              </el-col>
              <el-col :span=12>
                ...
                <el-col :span="12">
                  <el-form-item label="菜单排序" prop="rank">
                    <el-input-number style="width: 100%;" v-model="menuData.rank":min="1" :max="999" :value-on-clear="99" controls-position="right" />
                  </el-form-item>
                </el-col>
                <el-col v-if="menuData.menu_type == 3" :span="12">
                ...
                <el-col v-if="menuData.menu_type == 0 || menuData.menu_type == 1" :span="12">
                  <el-form-item label="进场动画" prop="enterTransition">
                    <ReAnimateSelector
                      v-model="menuData.enterTransition"
                ...
                <el-col v-if="menuData.menu_type == 0 || menuData.menu_type == 1" :span="12">
                  <el-form-item label="离场动画" prop="leaveTransition">
                    <ReAnimateSelector
                      v-model="menuData.leaveTransition"
